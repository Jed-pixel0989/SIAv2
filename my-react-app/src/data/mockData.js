...
// Converted from SQL schema (database/schema.sql) and seed data (database/seed.sql)

// ─── 1. TARIFF CONFIGURATION (tariff_rates) ───────────────────────────────────
export const initialTariff = {
  residential: {
    minCharge: 180.00,   // base fee for first 10 m³
    minCuM: 10,
    bracket1: 22.50,     // 11–20 m³
    bracket2: 28.00,     // 21–30 m³
    bracket3: 35.00,     // 31+ m³
  },
  commercial: {
    minCharge: 360.00,
...
// ─── 3. METER ASSETS (meter_assets + meter_calibrations) ─────────────────────
export const initialMeters = [
  {
    ...
    status: 'Active',
    history: [
      { date: '2024-03-15', type: 'Installation',        technician: 'Roberto Ramos', accuracyMargin: '+/- 0.3%', result: 'Passed',       notes: 'Initial installation inspection completed without issue.' },
      { date: '2025-03-10', type: 'Routine Calibration', technician: 'Tomas Cruz',   accuracyMargin: '+/- 0.4%', result: 'Passed',       notes: 'Calibrated on mobile test bench; certified margin compliant.' },
    ],
  },
  {
    serialNo: 'MTR-77292',
    ...
    status: 'Active',
    history: [
      { date: '2023-11-20', type: 'Installation', technician: 'Gil Santos', accuracyMargin: '+/- 0.5%', result: 'Passed', notes: 'Installed with dual-check backflow preventer.' },
      { date: '2024-11-15', type: 'Calibration',  technician: 'Tomas Cruz', accuracyMargin: '+/- 0.5%', result: 'Passed', notes: 'Flow rate verified within standards.' },
    ],
  },
  {
    serialNo: 'MTR-77293',
    ...
    history: [
      { date: '2024-01-10', type: 'Installation',     technician: 'Gil Santos',  accuracyMargin: '+/- 0.5%', result: 'Passed',        notes: 'Commercial line connection.' },
      { date: '2025-01-08', type: 'Annual Calibration', technician: 'Tomas Cruz', accuracyMargin: '+/- 0.8%', result: 'Needs Overhaul', notes: 'Passed with minor dial adjustment; scheduled for replacement next cycle.' },
    ],
  },
  {
    serialNo: 'MTR-77294',
    ...
    status: 'Active',
    history: [
      { date: '2023-08-04', type: 'Installation', technician: 'Roberto Ramos', accuracyMargin: '+/- 0.5%', result: 'Passed', notes: 'Commercial water meter installed.' },
    ],
  },
  {
    serialNo: 'MTR-77295',
    ...
    status: 'Active',
    history: [
      { date: '2024-05-18', type: 'Installation', technician: 'Roberto Ramos', accuracyMargin: '+/- 0.5%', result: 'Passed', notes: 'Factory calibrated seal intact.' },
    ],
  },
  {
    serialNo: 'MTR-77296',
    ...
    status: 'Under Repair',
    history: [
      { date: '2022-09-12', type: 'Installation',    technician: 'Gil Santos',    accuracyMargin: '+/- 0.5%', result: 'Passed', notes: 'Standard residential meter.' },
      { date: '2026-08-28', type: 'Repair Scheduled', technician: 'Roberto Ramos', accuracyMargin: '+/- 1.4%', result: 'Failed', notes: 'Consumer reported glass fogging and condensation.' },
    ],
  },
  {
    serialNo: 'MTR-77297',
    ...
    status: 'Active',
    history: [
      { date: '2024-02-28', type: 'Installation', technician: 'Tomas Cruz', accuracyMargin: '+/- 0.5%', result: 'Passed', notes: 'New residential service.' },
    ],
  },
  {
    serialNo: 'MTR-77298',
    ...
    status: 'Active',
    history: [
      { date: '2023-04-14', type: 'Installation', technician: 'Gil Santos', accuracyMargin: '+/- 0.5%', result: 'Passed', notes: 'High flow bakery connection.' },
    ],
  },
]

// ─── 4. GEO PINS (geo_connections) ───────────────────────────────────────────
export const initialGeoPins = [
  { id: 'GP-1', consumerId: 'C-1001', name: 'Amina Okafor',     zone: 'Mabuhay',    cluster: 'Mabuhay',     lat: 14.618500, lng: 121.032000, x: 26, y: 28, status: 'Normal',      meterNo: 'MTR-77291', reading: 148 },
  { id: 'GP-2', consumerId: 'C-1002', name: 'Caleb Mensah',     zone: 'Riverside',   cluster: 'Pag-asa',     lat: 14.595000, lng: 121.054000, x: 64, y: 30, status: 'Overdue',     meterNo: 'MTR-77292', reading: 215 },
  { id: 'GP-3', consumerId: 'C-1003', name: 'Lina Santos',      zone: 'Hillview',    cluster: 'Maligaya',    lat: 14.582000, lng: 121.062000, x: 73, y: 64, status: 'Normal',      meterNo: 'MTR-77293', reading: 342 },
  { id: 'GP-4', consumerId: 'C-1004', name: 'Marco Dela Cruz',  zone: 'East Market', cluster: 'Pagkakaisa',  lat: 14.575000, lng: 121.038000, x: 38, y: 72, status: 'Normal',      meterNo: 'MTR-77294', reading: 198 },
  { id: 'GP-5', consumerId: 'C-1005', name: 'Elena Rostova',    zone: 'Mabuhay',    cluster: 'Mabuhay',     lat: 14.624000, lng: 121.026000, x: 18, y: 38, status: 'Normal',      meterNo: 'MTR-77295', reading: 89  },
  { id: 'GP-6', consumerId: 'C-1006', name: 'Danilo Aquino',    zone: 'Riverside',   cluster: 'Bungkalon',   lat: 14.602000, lng: 121.061000, x: 82, y: 22, status: 'Maintenance', meterNo: 'MTR-77296', reading: 412 },
  { id: 'GP-7', consumerId: 'C-1007', name: 'Sophia Villanueva',zone: 'Hillview',    cluster: 'Masagana',    lat: 14.579000, lng: 121.071000, x: 84, y: 75, status: 'Normal',      meterNo: 'MTR-77297', reading: 165 },
  { id: 'GP-8', consumerId: 'C-1008', name: 'Victor Tan Bakery',zone: 'East Market', cluster: 'Milina',      lat: 14.571000, lng: 121.045000, x: 48, y: 84, status: 'Normal',      meterNo: 'MTR-77298', reading: 512 },
]

// ─── 5. BILLING STATEMENTS (bills) ───────────────────────────────────────────
...
// ─── 6. PAYMENT TRANSACTIONS (payments) ──────────────────────────────────────
export const initialPayments = [
  {
    ...
    notes: 'Over-the-counter bill settlement.',
  },
  {
    id: 'PAY-3000',
    orNumber: 'OR-2026-9040',
    billId: 'WS-240890',
    consumerId: 'C-1005',
    consumerName: 'Elena Rostova',
    accountNo: 'ACC-88205',
    ...
    notes: 'Digital wallet instant settlement.',
  },
]

// ─── 7. MAINTENANCE & COMPLAINT TICKETS (maintenance_tickets) ─────────────────
...
export const initialAuditLogs = [
  ...
  },
  {
    ...
    target: 'OR-2026-9041 / Marco Dela Cruz',
...
// ─── 9. STAFF / HR RECORDS (users) ───────────────────────────────────────────
export const initialStaff = [
  { id: 'STF-01', fullName: 'Jamie Dizon',    role: 'Administrator', status: 'Active',   contact: '+63 917 111 2233', zone: 'All',         joinDate: '2020-01-10', openTickets: 0 },
  { id: 'STF-02', fullName: 'Roberto Ramos',  role: 'Field Staffs',  status: 'Active',   contact: '+63 918 222 3344', zone: 'Mabuhay',    joinDate: '2021-03-22', openTickets: 2 },
  { id: 'STF-03', fullName: 'Tomas Cruz',     role: 'Field Staffs',  status: 'Active',   contact: '+63 919 333 4455', zone: 'Hillview',   joinDate: '2021-06-15', openTickets: 1 },
  { id: 'STF-04', fullName: 'Gil Santos',     role: 'Field Staffs',  status: 'Active',   contact: '+63 920 444 5566', zone: 'Riverside',  joinDate: '2022-02-28', openTickets: 0 },
  ...
  { id: 'STF-06', fullName: 'Ana Fernandez',  role: 'Cashier',       status: 'Active',   contact: '+63 921 555 6677', zone: 'All',         joinDate: '2023-01-05', openTickets: 0 },
...
export const initialNotifications = [
  ...
  { id: 'NTF-002', type: 'Overdue Notice',   recipient: 'Caleb Mensah',   accountNo: 'ACC-88202', message: 'Your account is overdue by 14 days. Please settle ₱1,019.20 immediately.',           sentAt: '2026-09-03 09:00', status: 'Sent', channel: 'SMS'   },
...
// ─── 11. BILLING ADJUSTMENTS (billing_adjustments) ───────────────────────────
...
// ─── 12. SERVICE RATINGS (service_ratings) ────────────────────────────────────
...
// ─── UTILITY: Consumption Bill Calculator ─────────────────────────────────────
export function calculateConsumptionBill(prevReading, presReading, classification = 'Residential', tariff = initialTariff) {
  ...
  const rates = classKey === 'commercial'
    ? tariff.commercial
    : classKey === 'institutional'
    ? tariff.institutional
    : tariff.residential
